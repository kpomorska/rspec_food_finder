  ...
  describe '#number_to_currency' do
    ...
    context 'using default values' do
      ...
      it "correctly formats a float" do
        expect(number_to_currency(2000.01)).to eq('$2,000.01')
      end 
    ...
    context 'using custom options' do
      ...
      it 'allows changing the :precision' do
        expect(number_to_currency(2000, precision: 4)).to eq('$2,000.0000')
      end
      ...
      it 'correctly formats using multiple options' do
        expect(number_to_currency(2000, {precision: 0, unit: '£'})).to eq('£2,000')  
      end
